...
package com.firdausmaulan.materialdaterangepicker.date;
...
import com.firdausmaulan.materialdaterangepicker.HapticFeedbackController;
import com.firdausmaulan.materialdaterangepicker.R;
import com.firdausmaulan.materialdaterangepicker.TypefaceHelper;
import com.firdausmaulan.materialdaterangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
        OnClickListener, com.firdausmaulan.materialdaterangepicker.date.DatePickerController {
    ...
    private com.firdausmaulan.materialdaterangepicker.date.AccessibleDateAnimator mAnimator;
    ...
    private com.firdausmaulan.materialdaterangepicker.date.DayPickerView mDayPickerView;
    private com.firdausmaulan.materialdaterangepicker.date.YearPickerView mYearPickerView;
    ...
    private com.firdausmaulan.materialdaterangepicker.date.SimpleDayPickerView mDayPickerViewEnd;
    private com.firdausmaulan.materialdaterangepicker.date.YearPickerView mYearPickerViewEnd;
    private com.firdausmaulan.materialdaterangepicker.date.AccessibleDateAnimator mAnimatorEnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDayPickerView = new com.firdausmaulan.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerView = new com.firdausmaulan.materialdaterangepicker.date.YearPickerView(activity, this);
        mDayPickerViewEnd = new com.firdausmaulan.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerViewEnd = new com.firdausmaulan.materialdaterangepicker.date.YearPickerView(activity, this);
        ...
        mAnimator = (com.firdausmaulan.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator);
        mAnimatorEnd = (com.firdausmaulan.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator_end);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay calendarDay;
                if(tabId.equals("start")){
                    calendarDay = new com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar.getTimeInMillis());
                    mDayPickerView.goTo(calendarDay,true,true,false);
                }
                else{
                    calendarDay = new com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
    ...
    @Override
    public com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay getSelectedDay() {
        if(tabHost.getCurrentTab()==0){
            return new com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar);
        }else{
            return new com.firdausmaulan.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd);
        }
