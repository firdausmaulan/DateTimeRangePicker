...
package com.firdausmaulan.materialdaterangepicker.time;
...
import com.firdausmaulan.materialdaterangepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOkButton.setText(getString(R.string.mdtp_next));
        mOkButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOkButton.getText().toString().equals(getString(R.string.mdtp_next))){
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if(tabId=="start"){
                    ...
                    mOkButton.setText(getString(R.string.mdtp_ok));
                }
            }
        });
        return view;
